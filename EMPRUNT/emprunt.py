...
def create_emprunt(session):
    try:
        ...
        if new:
            print(f' Emprunt ID: {new.idemprunt}, Étudiant ID: {new.id_etud}, Livre ISBN: {new.isbn}, date emprunt: {new.dateemprunt}, date retour: {new.dateretour}, amende: {new.amende} ')
        else:
...
def emprunts_par_date_emprunt(session):
    try:
        ...
        if liste:
            ...
            for el in liste:
                print(f" Emprunt ID: {el.idemprunt}, Date emprunt: {el.dateemprunt}, Étudiant ID: {el.id_etud},Etudiant nom : {el.etudiant.nom} , Livre ISBN: {el.isbn}, Livre titre: {el.livre.titre}, ammende: {el.amende} ")
        else:
    ...
    try:
        ...
        if liste:
            ...
            for el in liste:
                ...
                print(f" Emprunt ID: {el.idemprunt}, Étudiant ID: {el.id_etud},Etudiant nom : {el.etudiant.nom} , Livre ISBN: {el.isbn}, Livre titre: {el.livre.titre}, ammende: {el.amende} ")
        else:
...
def livres_non_retournes(session):
    try:
        ...
        if liste:
            ...
            for el in liste:
                print(f"{el.idemprunt}, Date retour: {el.dateretour}, Étudiant ID: {el.id_etud},Etudiant nom : {el.etudiant.nom} , Livre ISBN: {el.isbn}, Livre titre: {el.livre.titre}, ammende: {el.amende} ")
        else:
    ...
    try:
        ...
        if emprunts:
            ...
            for emprunt in emprunts :
                print(f" Emprunt ID: {emprunt.idemprunt}, Étudiant ID: {emprunt.id_etud},Etudiant nom : {emprunt.etudiant.nom} , Livre ISBN: {emprunt.isbn}, Livre titre: {emprunt.livre.titre}, ammende: {emprunt.amende} ")
        else:
